...
public class EmailServiceImpl implements EmailService{
	...
	@Override
	public String sendCardGenerationConfirmation(String customerName, String customerEmail, byte[] front, byte[] back) {
		try {
		        ...
		        props.put("name", customerName);
		        props.put("sign", "Banking Application");
		        props.put("location", "Fremont CA100 , USA");
		        props.put("email", "achieverarun10@gmail.com");
		        context.setVariables(props);
		        String html = templateEngine.process("cardGenerationMail.html", context);
		        helper.setTo(customerEmail);
		        helper.setText(html, true);
		        helper.setSubject("Regarding card generation!!");
		        helper.setFrom("achieverarun10@gmail.com");
		        
		        
				 InputStreamSource aimageSource =new ByteArrayResource(front);
				 helper.addInline("ab", aimageSource,"image/png");
				  
				 InputStreamSource bimageSource =new ByteArrayResource(back);
				 helper.addInline("bb", bimageSource,"image/png");
				 
				 
		        File cfile=new ClassPathResource("images/creditcard.jpg", EmailServiceImpl.class.getClassLoader()).getFile();
	...
	@Override
	public String sendURNemail(String email, Integer urnEmail) {
		try {
			    MimeMessage message = javaMailSender.createMimeMessage();
		        MimeMessageHelper helper = new MimeMessageHelper(message,
		                MimeMessageHelper.MULTIPART_MODE_MIXED_RELATED,
		        ...
		        Context context = new Context();
		        Map<String,Object> props=new HashMap<>();
		        props.put("urn", Integer.toString(urnEmail));
		        props.put("sign", "Banking Application");
		        props.put("location", "Fremont CA100 , USA");
		        props.put("email", "achieverarun10@gmail.com");
		        context.setVariables(props);
		        String html = templateEngine.process("urnEmail.html", context);
		        helper.setTo(email);
		        helper.setText(html, true);
		        helper.setSubject("Regarding added payee!!");
		        helper.setFrom("achieverarun10@gmail.com");	 
				 
		        File cfile=new ClassPathResource("images/payeeAdded.jpg", EmailServiceImpl.class.getClassLoader()).getFile();
		        byte[] cbytes=Files.readAllBytes(cfile.toPath());
		        InputStreamSource cimageSource =new ByteArrayResource(cbytes);
		        helper.addInline("cb", cimageSource, "image/png");
