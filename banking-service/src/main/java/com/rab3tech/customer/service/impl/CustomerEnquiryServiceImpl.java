...
import com.rab3tech.customer.dao.repository.Location1Repository;
...
public class CustomerEnquiryServiceImpl implements CustomerEnquiryService {
	...
	@Autowired
	private Location1Repository location1Repository;
	...
	public List<String> findAllAccountType(){
		return accountTypeRepository.findMyAccountType();
	}
	
	@Override
	public List<String> findAllLocation(){
		return location1Repository.findMyLocation();
	}
